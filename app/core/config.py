...
class Settings(BaseSettings):
    ...
    CORS_ORIGINS: str = "http://localhost:5173,http://localhost:8090,http://127.0.0.1:5173,http://localhost:3000,http://localhost:8080,https://sastoho.store,https://www.sastoho.store"
